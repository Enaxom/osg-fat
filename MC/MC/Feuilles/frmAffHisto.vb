...
Public Class frmAffHisto
    ...
    Private Sub charger_labels()
        ...
        If classParent.connect_ADO.ADODB_connection(1) Then
            ...
            Me.btnRechercheA_div.Text = rs.Fields("Libelle").Value
            Me.btnRechercheASar.Text = rs.Fields("Libelle").Value
            rs.Close()
    ...
    Private Sub cboFiltre_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboFiltre.SelectedIndexChanged
        ...
        ElseIf cboFiltre.SelectedItem.nom = "DIV" Then
            Me.btnRechercheA_div.Visible = True
            Me.BtnRechercheA.Visible = False
            Me.btnRechercheASar.Visible = False

        ElseIf cboFiltre.SelectedItem.nom = "OPEDAN" Then
            Me.btnRechercheASar.Visible = True
            Me.btnRechercheA_div.Visible = False
            Me.BtnRechercheA.Visible = False
    ...
    Private Sub RechecheA_div_Click(sender As System.Object, e As System.EventArgs) Handles btnRechercheA_div.Click

        Dim DD, df As Double

        Dim fen As New frmRechercheADiv(_fichierIni, _iD_MACHINE, _iD_USER, Me)
    ...
    Private Sub btnRechercheASar_Click(sender As System.Object, e As System.EventArgs) Handles btnRechercheASar.Click
        Dim DD, df As Double

        Dim fen As New frmRechercheASar(_fichierIni, _iD_MACHINE, _iD_USER, Me)
