    ...
    Private Sub charger_labels()
        ...
        If ClassParent.connect_ADO.ADODB_connection(1) Then
            ...
            If ClassParent.connect_ADO.ADODB_connection(2) Then
                ...
                'BOUTON FORMATION
                If droit1(18) = "1" And droit2(18) = "1" Then
                    btnFormation.Visible = True
                Else
                    btnFormation.Visible = False
                End If
                'BOUTON BROUILLON
                If droit1(27) = "1" And droit2(27) = "1" Then
                    btnBrouillon.Visible = True
                Else
                ...
                If droit1(33) = "1" And droit2(33) = "1" Then
                    ...
                    btnRappel.Visible = True
                    btnRappel.ToolTip = "F1 - " & rs.Fields("Libelle").Value
                    btnRappel.Left = position
                    position = position + 70
                Else
                    btnRappel.Visible = False
                End If
                rs.Close()
                ...
                If droit1(34) = "1" And droit2(34) = "1" Then
                    ...
                    btnMvtPersonne.Visible = True
                    btnMvtPersonne.ToolTip = "F2 - " & rs.Fields("Libelle").Value
                    btnMvtPersonne.Left = position
                    position = position + 70
                Else
                    btnMvtPersonne.Visible = False
                End If
                rs.Close()
                ...
                If droit1(35) = "1" And droit2(35) = "1" Then
                    ...
                    btnMvtMateriel.Visible = True
                    btnMvtMateriel.ToolTip = "F3 - " & rs.Fields("Libelle").Value
                    btnMvtMateriel.Left = position
                    position = position + 70
                Else
                    btnMvtMateriel.Visible = False
                End If
                rs.Close()
                ...
                If droit1(36) = "1" And droit2(36) = "1" Then
                    ...
                    btnDivers.Visible = True
                    btnDivers.ToolTip = "F4 - " & rs.Fields("Libelle").Value
                    btnDivers.Left = position
                    position = position + 70
                Else
                    btnDivers.Visible = False
                End If
                rs.Close()
                ...
                If droit1(37) = "1" And droit2(37) = "1" Then
                    ...
                    btnActPrev.Visible = True
                    btnActPrev.ToolTip = "F5 - " & rs.Fields("Libelle").Value
                    btnActPrev.Left = position
                    position = position + 70
                Else
                    btnActPrev.Visible = False
                End If
                rs.Close()
                ...
                If droit1(39) = "1" And droit2(39) = "1" Then
                    ...
                    btnInter.ToolTip = "F6 - " & rs.Fields("Libelle").Value
                    btnInter.Left = position
                    position = position + 70
                Else
                ...
                If droit1(41) = "1" And droit2(41) = "1" Then
                    ...
                    btnReleve.Visible = True
                    btnReleve.ToolTip = "F7 - " & rs.Fields("Libelle").Value
                    btnReleve.Left = position
                    position = position + 70
                Else
                    btnReleve.Visible = False
                End If
                rs.Close()
                ...
                If droit1(38) = "1" And droit2(38) = "1" Then
                    ...
                    btnRonde.Visible = True
                    btnRonde.ToolTip = "F8 - " & rs.Fields("Libelle").Value
                    btnRonde.Left = position
                    position = position + 70
                Else
                    btnRonde.Visible = False
                End If
                rs.Close()
                ...
                If SAR_OK Then
                    ...
                    If droit1(42) = "1" And droit2(42) = "1" Then
                        ...
                        btnSar.Visible = True
                        btnSar.ToolTip = "F9 - " & rs.Fields("Libelle").Value
                        btnSar.Left = position
                        position = position + 70
                    Else
                        btnSar.Visible = False
                    End If
                    rs.Close()
                Else
                    btnSar.Visible = False
                ...
                If ClassParent.IsRIT And droit1(51) = "1" And droit2(51) = "1" Then
                    ...
                    If droit1(39) = "1" And droit2(39) = "1" Then
                        ...
                        btnDit.Visible = True
                        btnDit.ToolTip = "F10 - " & rs.Fields("Libelle").Value
                        btnDit.Left = position
                        position = position + 70
                    Else
                        btnDit.Visible = False
                    End If
                    rs.Close()
                Else
                    btnDit.Visible = False
                ...
                If ClassParent.IsSSLIA Then
                    ...
                    If droit1(39) = "1" And droit2(39) = "1" Then
                        ...
                        btnAero.Visible = True
                        btnAero.ToolTip = "F11 - " & rs.Fields("Libelle").Value
                        btnAero.Left = position
                        position = position + 70
                    Else
                    ...
                    If droit1(39) = "1" And droit2(39) = "1" Then
                        ...
                        btnSituation.Visible = True
                        btnSituation.ToolTip = "F12 - " & rs.Fields("Libelle").Value
                        btnSituation.Left = position
                        position = position + 70
                    Else
                        btnSituation.Visible = False
                    End If
                    rs.Close()
                Else
                    btnSituation.Visible = False
            ...
            rs = ClassParent.connect_ADO.ADODB_create_recordset(1, "SELECT * FROM LANGUE WHERE IdObjet='FORMATION_ADMIN' AND idLangue='TITRE'")
            Me.btnFormation.ToolTip = rs.Fields("Libelle").Value
            rs.Close()

            rs = ClassParent.connect_ADO.ADODB_create_recordset(1, "SELECT * FROM LANGUE WHERE IdObjet='ACCUEIL' AND IdLangue='BROUILLON';")
            Me.btnBrouillon.ToolTip = rs.Fields("Libelle").Value
            rs.Close()
    ...
    Private Sub TimerBCL_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TimerBCL.Tick
        ...
        If Me.Visible Then
            ...
            If Me.Visible Then
                ...
                End If
                If ClassParent.IsHetC And ClassParent.IsHetCRappel Then
                    Me.TimerBCL.Enabled = False
                    Me.ClassParent.LancerRappelsHetC()
                End If
    ...
    Friend Function exec(ByVal Lemode As Integer, ByVal item As grid_row) As Boolean
        Try
            ...
            If droit_ok Then
                ...
                Else
                    If UCase(item.TypeObj) = "OPEDAN" Or UCase(item.TypeObj) = "OPEMAIN" Or UCase(item.TypeObj) = "DIA" Or UCase(item.TypeObj) = "DIT" Or UCase(item.TypeObj) = "SLVP" Then
...
IDMAchine_Retour_erreur:
    ...
    Private Sub btnTraka_Click(sender As System.Object, e As System.EventArgs) Handles btnTraka.Click
        ...
        If Me.ClassParent.IsTraka Then
            Me.ClassParent.LancerTraka()
        Else
            If Me.ClassParent.IsHetC Then
                Me.ClassParent.LancerHetC()
            End If
        End If
    ...
    Public Function openEvent(typeEvnt)

        Dim obj As grid_row = New grid_row(ClassParent)
        obj.TypeObj = typeEvnt
        obj.CleObj = 0
        'MsgBox("a")
        exec(0, obj)
        'MsgBox("b")
    ...
    Private Sub btnRappel_Click(sender As System.Object, e As System.EventArgs) Handles btnRappel.Click
        openEvent("RAPPEL")
    End Sub

    Private Sub btnMvtPersonne_Click(sender As System.Object, e As System.EventArgs) Handles btnMvtPersonne.Click
        openEvent("MVTPERSO")
    End Sub

    Private Sub btnMvtMateriel_Click(sender As System.Object, e As System.EventArgs) Handles btnMvtMateriel.Click
        openEvent("MVTMAT")
    End Sub

    Private Sub btnDivers_Click(sender As System.Object, e As System.EventArgs) Handles btnDivers.Click
        openEvent("DIV")
    End Sub

    Private Sub btnActPrev_Click(sender As System.Object, e As System.EventArgs) Handles btnActPrev.Click
        openEvent("OPEMAIN")
    End Sub

    Private Sub btnInter_Click(sender As System.Object, e As System.EventArgs) Handles btnInter.Click
        openEvent("DINTER")
    End Sub

    Private Sub btnReleve_Click(sender As System.Object, e As System.EventArgs) Handles btnReleve.Click
        openEvent("RELEVE")
    End Sub

    Private Sub btnRonde_Click(sender As System.Object, e As System.EventArgs) Handles btnRonde.Click
        openEvent("RONDE")
    End Sub

    Private Sub btnSar_Click(sender As System.Object, e As System.EventArgs) Handles btnSar.Click
        openEvent("OPEDAN")
    End Sub

    Private Sub btnSituation_Click(sender As System.Object, e As System.EventArgs) Handles btnSituation.Click
        openEvent("SLVP")
    End Sub

    Private Sub btnAero_Click(sender As System.Object, e As System.EventArgs) Handles btnAero.Click
        openEvent("DIA")
    End Sub

    Private Sub btnDit_Click(sender As System.Object, e As System.EventArgs) Handles btnDit.Click
        openEvent("DIT")
    End Sub

    Private Sub btnFormation_Click(sender As System.Object, e As System.EventArgs) Handles btnFormation.Click
        Me.btnFormation.Enabled = False
        Try

            Dim ModuleDLL As New Rapport_de_Formation.Init_Formation

            If ModuleDLL.Init(_fichierIni, ClassParent.IDMachine, ClassParent._ID_USER, 0) Then
                If Not ModuleDLL.Execute() Then
                End If
            End If
            ModuleDLL = Nothing
            Me.btnFormation.Enabled = True
        Catch ex As Exception
            DevExpress.XtraEditors.XtraMessageBox.Show(ex.Message, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End Try
    End Sub

    Private Sub btnBrouillon_Click(sender As System.Object, e As System.EventArgs) Handles btnBrouillon.Click
        Me.btnBrouillon.Enabled = False
        Try

            Dim ModuleDLL As New VisuBrouillon.VisualisationBrouillon

            If ModuleDLL.Init(_fichierIni, ClassParent.IDMachine, ClassParent._ID_USER) Then
                ModuleDLL.Execute()
            End If
            ModuleDLL = Nothing
            Me.btnBrouillon.Enabled = True
        Catch ex As Exception
            DevExpress.XtraEditors.XtraMessageBox.Show(ex.Message, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End Try
    End Sub

    Private Sub SimpleButton1_Click(sender As System.Object, e As System.EventArgs) Handles btnExportImportData.Click
        Dim feuille As New frmTablette(Me)
        If feuille.Init() Then
            feuille.ShowDialog()
        End If
    End Sub
